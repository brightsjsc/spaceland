...
@section('content')
  <div class="container-fluid">
      ...
      <div class="col-md-12">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.productCate.index') }}">Menu</a></li>
    ...
    <form action="{{ route('admin.system.menu.store') }}" method="POST">
      @csrf
      <div class="row">
        <!-- <div class="col-md-12"> -->
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="row">
                          <label class="col-md-3 col-form-label required">Tên menu</label>
                          <div class="col-md-9">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="row">
                          <label class="col-md-3 col-form-label required">URL</label>
                          <div class="col-md-9">
                            <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="row">
                          <label class="col-md-3 col-form-label required">Menu cha</label>
                          <div class="col-md-9">
                            <div class="form-group">
                                    ...
                                    foreach ($data as $value) {
                                      ...
                                      if($parent_id == $parent) {
                                        if(($select != 0) && ($id == $select)) {
                                          echo "<option value='$id' selected>$str $title</option>";
                                        }else{
                            ...
                            <div class="form-group">
                              <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                  <input class="form-check-input" name="prioritize" type="radio" checked @if(old('prioritize') == 0) checked @endif value="0"> MAIN MENU
                                  <span class="circle">
                              ...
                              <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                  <input class="form-check-input" name="prioritize" type="radio" @if(old('prioritize') == 1) checked @endif value="1"> FOOTER MENU
                                  <span class="circle">
                                    <span class="check"></span>
                                  </span>
                                </label>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-9">
                            <div class="form-group">
                              <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                  <input class="form-check-input" name="status" type="radio" checked @if(old('status') == 0) checked @endif value="0"> ON
                                  <span class="circle">
                                    <span class="check"></span>
                                  </span>
                                </label>
                              ...
                              <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                  <input class="form-check-input" name="status" type="radio" @if(old('status') == 1) checked @endif value="1"> OFF
                                  <span class="circle">
                                    <span class="check"></span>
                                  </span>
                                </label>
