...
@section('content')
  <div class="container-fluid">
      ...
      <div class="col-md-12">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.system.menu.index') }}">Danh mục</a></li>
    ...
    <form action="{{ route('admin.system.menu.update',['id' => $category['id']]) }}" method="POST">
      @csrf
      <div class="row">
        <!-- <div class="col-md-12"> -->
          <div class="col-md-9 pdr-0">
            <div class="card">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <h4 class="card-title">{{ "Sửa danh mục: ".$category['title'] }}</h4>
                  </div>
                </div>
              </div>
              <div class="card-body">
                          ...
                          <div class="col-md-9">
                            <div class="form-group">
                              <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                  <input class="form-check-input" name="prioritize" type="radio" 
                                    @if($category['prioritize'] == 0) checked @endif value="0"> MAIN MENU
                                  <span class="circle">
                              ...
                              <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                  <input class="form-check-input" name="prioritize" type="radio" 
                                    @if($category['prioritize'] == 1) checked @endif value="1"> FOOTER MENU
                                  <span class="circle">
                                    <span class="check"></span>
                                  </span>
                                </label>
