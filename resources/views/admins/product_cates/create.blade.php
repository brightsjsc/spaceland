...
@section('content')
  <div class="container-fluid">
    ...
    <form action="{{ route('admin.productCate.store') }}" method="POST">
      @csrf
      <div class="row">
        <!-- <div class="col-md-12"> -->
                            ...
                            <div class="form-group">
                              <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                  <input class="form-check-input" name="prioritize" type="radio" checked @if(old('prioritize') == 0) checked @endif value="0"> ON
                                  <span class="circle">
                              ...
                              <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                  <input class="form-check-input" name="prioritize" type="radio" @if(old('prioritize') == 1) checked @endif value="1"> OFF
                                  <span class="circle">
                                    <span class="check"></span>
                                  </span>
                                </label>
