                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="name"
                                                        value="{{ $product->name }}" placeholder="Nhập tiêu đề">
                                                    @if ($errors->has('name'))
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <select class="form-control" name="product_cate_id">
                                                        ...
                                                        <?php
                                cate_parent($categories,0,'',$product->product_cate_id);
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <select class="form-control" name="adr_city_id">
                                                        ...
                                                        <option value="{{ $city->city_id }}" @if($product->project_id)
                                                            @if($city->city_id == $product->project->adr_city_id)
                                                            selected @endif
                                                            @endif
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <select class="form-control" name="adr_district_id">
                                                        ...
                                                        <option value="{{ $district->district_id }}" @if($district->
                                                            district_id == $product->project->adr_district_id) selected
                                                            @endif
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <select class="form-control" name="adr_commune_id">
                                                        ...
                                                        <option value="{{ $commune->commune_id }}" @if($commune->
                                                            commune_id == $product->project->adr_commune_id) selected
                                                            @endif
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <select class="form-control" name="project_id[]" multiple="multiple"
                                                        id="project">
                                                        <option value=""> --- Chọn dự án --- </option>
                                                        @if($product->project_id)
                                                        @foreach ($projects as $project)
                                                        <option value="{{ $project->id }}"
                                                        @foreach ($chosen_projects as $chosen_project)
                                                        @if($project->id ==
                                                            $chosen_project->id) selected
                                                        @endif
                                                        @endforeach
                                                        > {{ $project->name }} </option>
                                                        @endforeach
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <label class="col-md-4 col-form-label required">Diện tích</label>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <select class="form-control" name="price_type">
                                                        ...
                                                        <option value="1" @if($product->price_type == 1) selected
                                                            @endif> /tháng </option>
                                                        <option value="2" @if($product->price_type == 2) selected
                                                            @endif> /m2 </option>
                                                    </select>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <small> <i class="text-rose">Lưu ý: tin rao chỉ để mệnh giá tiền Việt Nam Đồng.</i>
                                </small>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="witdh"
                                                        value="{{ $product->witdh }}">
                                                    @if ($errors->has('witdh'))
                                                    <span class="invalid-feedback text-right" style="display: block;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="land_witdh"
                                                        value="{{ $product->land_witdh }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="home_direction"
                                                        value="{{ $product->home_direction }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="bacon_direction"
                                                        value="{{ $product->bacon_direction }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="toilet_number"
                                                        value="{{ $product->toilet_number }}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <textarea type="text" class="form-control" name="furniture"
                                                        rows="10">{{ $product->furniture }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <textarea type="text" class="form-control" name="legality"
                                                        rows="5">{{ $product->legality }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <input type="file" class="form-control" id="imgload" name="image"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <input type="file" class="form-control" id="gallery-load" name="gallery[]"
                                                multiple style="opacity: 1; position: static;"><br>
                            ...
                            if (!empty($gallerys)) {
                              foreach ($gallerys as $gallery) {
                                ?>
                                                <img src="{{ asset('uploads/images/products/'.$gallery) }}" alt=""
                                                    class="gallery_pre">
                                                <?php
                              }
                            }
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="video_url"
                                                value="{{ $product->video_url }}" placeholder="Nhập link video">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="map"
                                                value="{{ $product->map }}" placeholder="Nhập tọa độ trên Google Map">
                                            @if ($errors->has('map'))
                                            <span class="invalid-feedback text-right" style="display: block;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" name="publish" type="radio"
                                                        value="0" @if($product->publish == 0) checked @endif
                                                    > Đã xuất bản
                                                    <span class="circle">
                                                        <span class="check"></span>
                                                    </span>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" name="publish" type="radio"
                                                        value="1" @if($product->publish == 1) checked @endif
                                                    > Chưa xuất bản
                                                    <span class="circle">
                                                        <span class="check"></span>
                                                    </span>
