...
<ul class="menu-mobile list-style-none">
    <li class="menu-child">
        ...
        <a href="{{ route('productsOfCity', ['city' => 'ho-chi-minh']) }} " style="color: white !important">
            Khu vực Hồ Chí Minh
        </a>
    </li>
    <li class="menu-child">
        ...
        <a href="{{ route('productsOfCity', ['city' => 'binh-duong']) }} " style="color: white !important">
            Khu vực Bình Dương
        </a>
    </li>
    <li class="menu-child">
        ...
        <a href="{{ route('productsOfCity', ['city' => 'dong-nai']) }} " style="color: white !important">
            Khu vực Đồng Nai
        </a>
    </li>
    {{-- <li class="menu-child">
