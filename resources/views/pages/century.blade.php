...
@section('content')
    ...
    <div
        style=" background-image: url('{{ asset('/uploads/images/projects/' . $project->image_des) }}');background-size: 100% 600px; height:600px">
        <div class="row">
            <div class="col-md">
    ...
    <br>
    <br>
    <div id="Scale" style="background: white">
        <div class="row">
            <div class="col">
            ...
            <div class="col" style="border: 2px solid #E65D26; height:500px">
    ...
    <div id="locate">
        ...
        <br>
        <div class="row" style="height:800px; background:#003456;">
            <div class="col" style="padding: 0">
                <div style="width:60%; margin-top:15%;background: rgba(0, 0, 0, 0.6); color:white;float: right">
                    <div style="background: #E65D26; height:10px"></div>
                    <br>
                    <h3 style="margin-left: 10px; margin-right:10%">GIỚI THIỆU VỀ DỰ ÁN @php
                        echo mb_strtoupper($project->name);
            ...
            <div class="col" style=" height:800px;float: left">
    ...
    <div id="investor" style="background: white">
        <div class="row">
            ...
            <div class="col" style="border: 2px solid #E65D26; height:500px;margin-top:5%">
    ...
    <br>
    <div style="
                                background:  rgba(248, 95, 34, 0.87) url('{{ asset('/assets/img/image 14.jpg') }}');
                                background-blend-mode: color-burn;
                                background-size: 100% 600px; height:600px;">
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="row" style="padding:20px 80px 20px 80px;">
                        <div class="col"
                            style="border: 2px solid white; height:500px; margin-top:50; padding:20px 80px 20px 80px;">
    ...
    <div
        style=" background-image: url('{{ asset('/uploads/images/projects/' . $project->image_ground) }}');background-size: 100% 900px; height:900px">
        <div class="row">
    ...
    <br>
    <br>
    <div id="ask" style="background: rgba(230, 93, 38, 0.85); width:100%;">
