                    ...
                    <div class="product-header">
                        ...
                        <div class="short-detail-wrap">
                            <ul class="short-detail-2 clearfix pad-16">
                                ...
                                <li><span class="sp1">Diện tích:</span><span class="sp2">{{ $product->acreage }}
                                        m2</span>
                                </li>
                    ...
                    <div class="product-body">
                        ...
                        @if ($product->map)
                            ...
                            <div class="map-product">
                                ...
                                <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDKCZyVb_cx2LH3onGkmE3l1Q5CuDKyygQ&callback=myMap">
                                </script>
                            </div>
                        @endif
                    </div>
                ...
                {{-- <div class="product-contact">
                    <div class="row">
                        <div class="col-6">
                            <div class="row">
                                <div class="col-5">
                                    <a href="tel:0913144599"><img src="{{ asset('assets/img/icon-hotline.gif') }}"
                                            width="100%" alt=""></a>
                                </div>
                    ...
                    <div class="contact-mobile">
                        <a data-toggle="modal" data-target="#exampleModal" class="btn btn-default btn-block">Đặt lịch tư
                            vấn</a>
                    </div>
                </div> --}}
